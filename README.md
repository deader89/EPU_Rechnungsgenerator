...
```bash
pyinstaller --noconfirm --onefile --windowed --name "EPU_Rechnungsgenerator" --add-data "layout.kv;." --add-data "Roboto-Regular.ttf;." --add-data "Roboto-Black.ttf;." --add-data "icon.png;." main.py
```
